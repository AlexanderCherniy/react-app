...
const initialState = {
    ...
    massages: [{ senderId: 0, body: MessagesPageInstructation, photo: Photo, viewed: false, id: '', senderName: '' ,recipientId: 1}],
}
...
export const getConcreteUserMessages = (userId: number):ThunkType => async (dispatch) => {
